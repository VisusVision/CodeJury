...
class RuntimeDiagnosticsTests(unittest.TestCase):
    ...
    def test_sandbox_snapshot_defaults_to_simulation_without_pool(self):
        snap = get_sandbox_pool_snapshot()
    ...
    def test_try_initialize_sandbox_pool_returns_simulation_when_pool_not_ready(self):
    ...
    def test_try_initialize_sandbox_pool_returns_pool_when_ready(self):
        ...
        ready_pool.is_ready = True
        ready_pool.available_count = 2
        ready_pool._slots = [1, 2]
        with patch("backend.sandbox.pool_manager.initialize_pool") as init_mock:
